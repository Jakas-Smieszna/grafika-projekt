...
int main()
{
	...
	VAO BIGlightVAO;
	BIGlightVAO.Bind();
	VBO BIGlightVBO(KulaVertices, sizeof(KulaVertices));
	EBO BIGlightEBO(KulaIndices, sizeof(KulaIndices));
	...
	glm::vec3 BIGlightPos = glm::vec3(0.0f, 1000000000.0f, 0.0f);
